...
const { addScore, submitClaim, getScores, getProfile, getLatestDraw, getWinnings, updateCharity, activateSubscription, selectCharity, uploadProof } = require('../controllers/userController')
...
router.post('/claim', verifyUser, submitClaim)
